...
<body>
  ...
  <div class="content container" style="text-align:center;">
    <!--nav bar-->
    <br> <br>
    <p style="font-size: 20px; font-weight: 500; color: darkblue;"> Remove Tenant </p>
    <br>
    

    <form method="post" class="form-add-building" >
      <div class="row mb-3">
        <label for="id" class="col-sm-3 col-form-label">Tenant id</label>
        <div class="col-sm-9">
    ...
    <?php
    $conn = mysqli_connect('localhost', 'root', '', 'apartmentdb');
   if(!$conn){
