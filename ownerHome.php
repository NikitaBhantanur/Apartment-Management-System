...
<body>
        ...
        <div class="col-lg-6" id="descriptive">
          <div class="contents d-flex flex-column justify-content-around">
            ...
            <h2 class="mb-3" style="font-family: 'Montserrat', sans-serif; color: black;">
              AMS is the right place for it!
              </h1>
              <h5 class="mb-3 mt-1" style="font-family: 'Montserrat', sans-serif; color: #281436;">
                This is a place where you can register your apartment, to whom did you rent the apartment as well as the details of your tenants so that whenever you want - you can have access to those information!
              ...
              <div class="mt-1">
                ...
                <a type="button" class="btn mb-2 btn-primary but-2" href="remove.php">Edit Tenant Details</a>
              </div>
          </div>
        </div>
  ...
  <footer class="footer footer-distributed sticky-bottom">
    ...
    <div class="footer-right">
      ...
      <p style="color: white; font-size: 16px; font-weight: bold;">Contact us at our E-mail ID</p>
      <a href="mailto:apoorvarodagi@gmail.com"><i class="fas fa-envelope"></i></a>
